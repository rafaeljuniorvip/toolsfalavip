...
function ToolCard({ path, label, desc, icon: Icon, color }) {
  return (
    <Link
      to={path}
      className="group bg-surface rounded-xl border border-border p-5 hover:border-primary/30 hover:shadow-md transition-all"
    >
      ...
      <h3 className="font-semibold text-text text-sm mb-1">{label}</h3>
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-8 mt-4">
        <h1 className="text-3xl font-bold text-text mb-2">Tools FalaVIP</h1>
      ...
      <section className="mb-8">
        <h2 className="text-sm font-semibold text-text-secondary uppercase tracking-wider mb-4 px-1">Ferramentas de Imagem</h2>
      ...
      <section>
        <h2 className="text-sm font-semibold text-text-secondary uppercase tracking-wider mb-4 px-1">Ferramentas de PDF</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
